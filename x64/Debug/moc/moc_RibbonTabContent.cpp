...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RibbonTabContent_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RibbonTabContent_t qt_meta_stringdata_RibbonTabContent = {
    {
QT_MOC_LITERAL(0, 0, 16) // "RibbonTabContent"
...
QT_INIT_METAOBJECT const QMetaObject RibbonTabContent::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_RibbonTabContent.data,
