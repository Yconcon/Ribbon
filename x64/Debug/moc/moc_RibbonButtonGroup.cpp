...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_RibbonButtonGroup_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_RibbonButtonGroup_t qt_meta_stringdata_RibbonButtonGroup = {
    {
QT_MOC_LITERAL(0, 0, 17) // "RibbonButtonGroup"
...
QT_INIT_METAOBJECT const QMetaObject RibbonButtonGroup::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_RibbonButtonGroup.data,
